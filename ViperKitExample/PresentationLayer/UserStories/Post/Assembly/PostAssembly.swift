...
class PostModuleAssembly: BaseViperAssembly {
    ...
    override init(withCollaborator collaborator: RootViperAssembly) {
        ...
        container.register { PostPresenter(interactor: $0, router: $1) }
        ...
        container.register { PostInteractor(postService: $0) }
